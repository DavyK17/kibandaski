...
const LoginLogout = props => {
    ...
    const Logout = (
        <svg id="iconLogout" width={iconHeight} height={iconHeight} viewBox="0 0 24 24" onClick={logoutClick}>
