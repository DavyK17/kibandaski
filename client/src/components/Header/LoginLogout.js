...
const LoginLogout = props => {
    ...
    // Login
    const Login = (
        <svg className="iconLogin" width={iconHeight} height={iconHeight} viewBox="0 0 24 24" onClick={handleLogin}>
    ...
    const Logout = loggingOut ? <Skeleton /> : (
        <svg className="iconLogout" width={iconHeight} height={iconHeight} viewBox="0 0 24 24" onClick={handleLogout}>
